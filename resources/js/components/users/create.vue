                  ...
                  <form class="user" @submit.prevent="addEmployee" enctype="multipart/form-data">
                    <div class="form-group">
                      <div class="form-row">
                        <div class="col-md-12">
                          <h4>Name</h4>
                          <input type="text" class="form-control" id="" placeholder="Enter Fullname"
                            v-model="form.name" />
                    ...
                    <div class="form-group">
                      <div class="form-row">
                        <div class="col-md-12">
                          <h4>PTR</h4>
                          <input type="text" class="form-control" id="" placeholder="Enter PTR" v-model="form.ptr" />
                    ...
                    <div class="form-group">
                      <div class="form-row">
                        <div class="col-md-12">
                          ...
                          <input type="text" class="form-control" id="" placeholder="Enter Specialization"
                    ...
                    <div class="form-group">
                      <button type="button" @click="clearSig()" class="btn btn-warning btn-block">
                        Clear Signature
                      </button>
  ...
  methods: {
    ...
    editForm() {
      ...
      axios
        ...
        .then(
          ({ data }) => (
            (this.form.name = !Object.keys(data).length === 0 ? this.form.name : data.name),
            (this.form.type = !Object.keys(data).length === 0 ? this.form.type : data.type),
            (this.form.prc = !Object.keys(data).length === 0 ? this.form.prc : data.prcno),
            (this.form.ptr = !Object.keys(data).length === 0 ? this.form.bp : data.ptr),
            (this.form.specialization = !Object.keys(data).length === 0 ? this.form.specialization : data.specialization),
            (this.form.signatureData = !Object.keys(data).length === 0 ? this.form.signatureData : data.signature),
            (this.form.id = !Object.keys(data).length === 0 ? this.form.id : data.id),
            (this.form.username = !Object.keys(data).length === 0 ? this.form.username : data.username),
            (this.form.password = !Object.keys(data).length === 0 ? this.form.password : data.password)
          )
        )
